...
const spaces: CoworkingSpace[] = [
  {
    ...
    name: 'WeWork',
    tier: 'enterprise',
    tagline: 'The largest coworking network in NYC',
    borough: 'Manhattan',
  ...
  },
  {
    ...
    name: 'Regus (IWG)',
    tier: 'enterprise',
    tagline: 'Global flexible office solutions',
    borough: 'Manhattan',
    address: 'Multiple locations across NYC',
    website: 'https://www.regus.com/en-us/united-states/new-york',
    priceRange: '$$$',
    amenities: ['Private Offices', 'Virtual Office', 'Meeting Rooms', 'Business Lounge', 'IT Support', 'Global Network'],
    description: 'Global leader in flexible workspaces with a vast NYC presence. Ideal for professionals and businesses needing scalable office solutions, virtual offices, or meeting rooms on demand.',
    multiLocation: true,
    accentColor: '#003087',
    bgColor: '#e8f0fb',
    textColor: '#003087',
  },
  {
    ...
    name: 'Spaces (by IWG)',
    tier: 'enterprise',
    tagline: 'Creative coworking with a boutique feel',
    borough: 'Manhattan',
    address: 'Multiple Manhattan & Brooklyn locations',
  ...
  },
  {
    ...
    name: 'Knotel',
    tier: 'enterprise',
    tagline: 'Flexible office solutions for enterprises',
    borough: 'Manhattan',
    address: 'Midtown & Downtown Manhattan',
    website: 'https://www.knotel.com',
    priceRange: '$$$$',
    amenities: ['Custom Buildouts', 'Full Floors', 'Dedicated IT', 'On-Demand Scaling', 'Premium Amenities', 'Branding Options'],
    description: 'Enterprise-focused flexible office provider specializing in fully customized, branded spaces for growing companies. Ideal for teams needing large-scale, turn-key office environments.',
    multiLocation: true,
    accentColor: '#1a1a2e',
    bgColor: '#eeeef5',
    textColor: '#1a1a2e',
  },
  {
    ...
    name: 'Industrious',
    tier: 'premium',
    tagline: 'Hospitality-style premium coworking',
    borough: 'Manhattan',
    address: 'Multiple Manhattan locations (Midtown, FiDi, Flatiron)',
    website: 'https://www.industriousoffice.com/cities/new-york-city',
    priceRange: '$$$$',
    amenities: ['Concierge Service', 'Premium Coffee', 'Wellness Rooms', 'Phone Booths', 'Printing', 'Stocked Kitchens'],
    description: 'Premium coworking known for hotel-quality service and beautifully designed offices. Offers private suites, dedicated desks, and day passes. A top choice for professionals who value comfort and service.',
    multiLocation: true,
    accentColor: '#2d6a4f',
    bgColor: '#d8f3dc',
    textColor: '#1b4332',
  },
  {
    ...
    name: 'The Yard',
    tier: 'community',
    tagline: 'NYC-born coworking with community at its core',
    borough: 'Manhattan',
    address: 'Manhattan, Brooklyn & Hoboken locations',
    website: 'https://theyard.com',
    priceRange: '$$',
    amenities: ['Hot Desks', 'Private Offices', 'Rooftop Access', 'Community Events', 'Dog Friendly', 'Meeting Rooms'],
    description: 'Homegrown NYC coworking brand with a strong community focus. Known for its welcoming atmosphere, member events, and thoughtfully designed spaces across Manhattan and Brooklyn.',
    multiLocation: true,
    accentColor: '#f4a261',
    bgColor: '#fff3e0',
    textColor: '#b5541a',
  },
  {
    ...
    tier: 'community',
    tagline: 'Modern design meets creative community',
    borough: 'Manhattan',
    address: 'Manhattan (Flatiron, Tribeca) & Brooklyn (Gowanus, Bushwick)',
    website: 'https://www.bondcollective.com',
    priceRange: '$$',
    amenities: ['Artisan Coffee', 'High-Speed Wi-Fi', 'Phone Booths', 'Printing', 'Lounge Areas', 'Event Space'],
    description: 'Boutique coworking with stunning interior design spanning Manhattan and Brooklyn. Popular among creatives, startups, and freelancers who want inspiring spaces without the enterprise price tag.',
    multiLocation: true,
    accentColor: '#6c63ff',
    bgColor: '#ede9fe',
    textColor: '#4c1d95',
  },
  {
    ...
    tier: 'popular',
    tagline: 'Coworking & private offices in the heart of SoHo',
    borough: 'Manhattan',
    address: '447 Broadway, 2nd Floor, New York, NY 10013',
    website: 'https://thefarmsohonyc.com',
    priceRange: '$$',
    amenities: ['Private Offices', 'Hot Desks', 'Podcast Studio', 'Phone Booths', 'High-Speed Wi-Fi', 'Printing'],
    description: 'A highly rated SoHo coworking space offering flexible memberships, private offices, and lease options. Loved for its accessible pricing, central location, and strong community vibe.',
    multiLocation: false,
    accentColor: '#52b788',
    bgColor: '#d8f3dc',
    textColor: '#1b4332',
  },
  {
    ...
    name: 'Rise New York',
    tier: 'popular',
    tagline: 'Fintech & innovation hub in the heart of NYC',
    borough: 'Manhattan',
    address: '43 W 23rd St, New York, NY 10010',
    website: 'https://www.rise.barclays/new-york',
    priceRange: '$$',
    amenities: ['Event Space', 'Mentorship Programs', 'Demo Kitchen', 'Meeting Rooms', 'Wi-Fi', 'Networking Events'],
    description: 'Barclays-backed innovation hub focused on fintech startups. Offers workspace, events, and access to a global network of mentors and investors. Ideal for early-stage fintech and tech companies.',
    multiLocation: false,
    accentColor: '#00aeef',
    bgColor: '#e0f7ff',
    textColor: '#006fa6',
  },
  {
    ...
    priceRange: '$$',
    amenities: ['Hot Desks', 'Dedicated Desks', 'Meeting Rooms', 'Natural Light', 'Community Events', 'Café'],
    description: 'A Brooklyn-based coworking community known for its relaxed, inclusive atmosphere. Perfect for remote workers, freelancers, and small teams who want a neighborhood feel over a corporate one.',
    multiLocation: false,
    accentColor: '#e76f51',
    bgColor: '#fde8e0',
    textColor: '#9d3a1e',
  },
  {
    ...
    name: 'OS NYC',
    tier: 'popular',
    tagline: 'Open-source workspace for creatives & entrepreneurs',
    borough: 'Manhattan',
    address: '594 Broadway, New York, NY 10012',
    website: 'https://www.osnyc.com',
    priceRange: '$$',
    amenities: ['Hot Desks', 'Private Suites', 'Podcast Studio', 'Photo Studio', 'Wellness Room', 'Rooftop'],
    description: 'A creative workspace in SoHo combining coworking with studio space for photographers, podcasters, and content creators. Unique amenity mix makes it a standout for media and creative professionals.',
    multiLocation: false,
    accentColor: '#023e8a',
    bgColor: '#e0eeff',
    textColor: '#023e8a',
  ...
  {
    id: 12,
    name: 'NYC Office Suites',
    tier: 'popular',
    tagline: 'Executive suites & virtual offices since 1992',
    borough: 'Manhattan',
    address: '1180 Avenue of the Americas, New York, NY 10036',
...
export default function CoworkingSpaces() {
  ...
  return (
    <section className="py-16" style={{ background: '#fafafa', borderTop: '1px solid #e5e7eb', paddingLeft: '16px', paddingRight: '16px' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 shadow-sm" style={{ border: '1px solid #e5e7eb' }}>
          <div className="mb-4">
            <p className="text-sm font-semibold text-gray-500 mb-2 uppercase tracking-wide">Space Type</p>
