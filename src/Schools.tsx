...
const schools: School[] = [
  ...
  { id: 75, name: 'PS 321 William Penn', type: 'primary school', borough: 'Brooklyn', address: '180 7th Ave, Brooklyn, NY 11215', phone: '(718) 499-2412', website: 'https://www.ps321.org', languages: ['English', 'Spanish'], description: "One of Brooklyn's most sought-after public elementary schools in Park Slope.", grades: 'PK-5' },
              ...
              {filtered.map(school => {
                ...
                return (
                  ...
                  >
                    ...
                    {school.grades && (
                      <p style={{ fontSize: '12px', fontWeight: 600, color: colors.text, marginBottom: '8px' }}>Grades: {school.grades}</p>
                    )}
                    ...
                    <div style={{ marginBottom: '14px' }}>
                      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '6px', marginBottom: '6px' }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#4b5563' }}>{school.address}</span>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <Phone style={{ width: '14px', height: '14px', color: '#9ca3af', flexShrink: 0 }} />
                        <span style={{ fontSize: '13px', color: '#4b5563' }}>{school.phone}</span>
                      </div>
                    </div>

                    {/* ── Language chips — inline style gap guaranteed ── */}
